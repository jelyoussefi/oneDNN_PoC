...
void convolution(dnnl::engine engine)  {
...
void depthwise_convolution(dnnl::engine engine) {
...
int main(int argc, char **argv) {
    ...
    auto q = dnnl::sycl_interop::get_queue(dnnl::stream(engine));
    std::cout << "\n---------------------------------------------------------------------------------" << std::endl;
